...
var scroll_posicao_y = self.rect_position.y
...
func _process(delta):
	self.connect("coordenadas_de_toque", self, "_manuseio_de_toque")
	
func _manuseio_de_toque(coordenadas):
	scroll_posicao_y += coordenadas.y
